    ...
    <>
      ...
      <Layout>
        ...
        <section className='grid grid-cols-1 gap-4 mt-10 px-3 sm:grid-cols-2 sm:px-5 lg:grid-cols-[auto_1fr_auto] lg:grid-rows-2 lg:px-2'>
          ...
          <div className='flex items-center justify-center space-x-4 py-10 bg-white rounded-[20px] shadow sm:col-span-2 md:col-auto lg:col-start-2 lg:col-end-3 lg:row-start-1 lg:row-end-3'>
            <p className='text-sm'>Poner grafico de barras</p>
          </div>

          <div className='flex flex-col space-y-7 px-4 py-6 bg-white rounded-[20px] shadow overflow-hidden sm:col-span-2 md:col-auto lg:col-start-3 lg:col-end-4 lg:row-start-1 lg:row-end-3'>
            <h2 className='text-xl font-medium text-gray-700'>Asuntos</h2>

            <div className='flex items-center justify-center'>
              <PieChart strokeWidth='20' sqSize='220' percentage={70} />
            </div>
